...
const leaguesData = {
  "bbl": { name: "BBL", src: BBL, url: "https://example.com/bbl" },
  "psl": { name: "PSL", src: PSL, url: "https://example.com/psl" },
  "bpl": { name: "BPL", src: BPL, url: "https://example.com/bpl" },
  "ipl": { name: "IPL", src: "https://livematchzone.com/wp-content/uploads/2025/03/IPL-2025-Team-2.webp", url: "https://example.com/ipl" },
  "sa20": { name: "SA20", src: SA, url: "https://example.com/sa20" },
  "ilt20": { name: "ILT20", src: ILT20, url: "https://example.com/ilt20" },
  "la-liga": { name: "La Liga", src: "https://livematchzone.com/wp-content/uploads/2025/03/La-Liga-1024x597.webp", url: "https://example.com/laliga" },
