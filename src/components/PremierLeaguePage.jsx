...
const PremierLeaguePage = () => {
  ...
  useEffect(() => {
    document.title = `Watch Free Live ${premierleagueData.name} Online`;
  }, []);
    ...
    <div className="flex flex-col items-center min-h-screen bg-black text-white">
      ...
      >
        <h1 className={`text-3xl font-bold ${showChat ? "mr-86" : "mx-auto"}`}>
          Watch Free Live {premierleagueData.name} Online
        </h1>
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              <img
                src={premierleagueData.src}
                alt={premierleagueData.name}
                className="w-12 h-12 border-2 border-white rounded-md"
              />
              <span className="text-white font-semibold text-lg">
                {premierleagueData.name}
              </span>
            </div>
